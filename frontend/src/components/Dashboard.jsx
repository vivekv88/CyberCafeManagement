    ...
    <div>
      ...
      <div className='w-[2px] h-[100vh] bg-red-900 ml-[15vw] mt-[0px] relative'>
        <div className='bg-cyan-100 w-[84.9vw] h-full ml-[1px]'>
          ...
          <Link to='/logout'><button className='cursor-pointer text-white text-[12px] font-serif font-semibold w-[5.4vw] py-2 rounded-lg  bg-gray-900 mb-[10px]'>Logout</button></Link>
